...
;; default uncaught exception handler. Individual Threads and 
;; ThreadGroups can have their own handlers, which get called
;; in preference to the default handler. 
