...
(defn value-kind->value
  ...
  (gloss/compile-frame
   (case kind
     ...
     :RDB_TYPE_STREAM_LISTPACKS        (streams/parse-stream-listpacks)
     ...
     :RDB_TYPE_STREAM_LISTPACKS_2      (streams/parse-stream-listpacks-2)
     :RDB_TYPE_SET_LISTPACK            (string/parse-string-encoded-value)
     :RDB_TYPE_STREAM_LISTPACKS_3      (streams/parse-stream-listpacks-3)
